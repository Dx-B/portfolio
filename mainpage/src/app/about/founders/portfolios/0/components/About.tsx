    ...
    <div className="flex justify-center">
      <div className="w-full m-4">
        ...
        <button
          ...
          className="w-full flex items-center justify-between bg-white/20 dark:bg-black/10 outline outline-white/20 dark:outline-white/10 backdrop-blur-sm rounded-xl p-4">
        ...
        >
          <div
            className="p-5 rounded-xl bg-white/25 dark:bg-black/20 backdrop-blur-md outline outline-white/20 dark:outline-white/10">

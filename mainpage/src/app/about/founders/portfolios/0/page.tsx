...
export default function Home() {
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="flex justify-center">
          <div className="h-[80vh] bg-white/25 dark:bg-black/25 m-[4vh] p-[2vh] rounded-xl space-y-3 flex flex-col">
            ...
            <h1 className="text-4xl font-bold text-shadow-[0_0_12px_rgba(255,255,255,0.3)] bg-linear-to-r from-indigo-400 via-purple-500 to-pink-500 bg-clip-text text-transparent tracking-tight">Your Dreams</h1>
            
            <h1 className="text-5xl font-bold text-shadow-[0_0_12px_rgba(255,255,255,0.3)]">My Passion</h1>
  ...
  <div className="h-[80vh] w-full m-4 p-4 rounded-xl bg-white/20 dark:bg-black/10  flex flex-col">
    ...
    {/* Header */}
    <h1 className="text-4xl font-bold mb-3 text-shadow-[0_0_12px_rgba(255,255,255,0.3)]">What's up?</h1>

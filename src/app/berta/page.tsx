...
export default function BertaPage() {
  return (
    <main>
      <Header />
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col items-center space-y-4 px-6">
                <Link href="/about/founders/portfolios/0">
                  <button className="cursor-pointer rounded-3xl px-26 py-4 font-bold outline-1 outline-indigo-500/60 shadow-[0_0_12px_rgba(131,58,246,0.6)] transition dark:font-normal dark:outline-indigo-400 dark:bg-black/70 bg-white/60">
                    Get Started
                  </button>
                </Link>
              </div>
